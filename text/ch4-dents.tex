...
\label{sec:4-5-theory}
    ...
    \subsection{Preliminaries - Exp}
        ...
        \begin{proofoutline}
            ...
            \end{align}
            \todo{clean up the use of alpha in this one. Should be alpha dents, and need to work out if should be using a sup or inf or whatever. Maybe just put a sup outside it.}
        ...
        \todo{here here here. Next time = consider just defining a logsumexp function, and define the temp to have at zero it equal to max. Also finish writing up the preliminaries}
