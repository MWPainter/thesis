...
\label{sec:2-1-mdps}
    ...
    HERE HERE HERE
    \todo{want to define policy, and then have a second paragraph, with a list, defining notation that we'll use for policies. Want to say something like, ``we will use xxxx as a shorthand to define deterministic distributions''.}
    ...
    \todo{actually state the the values of a policy need to add to one}
