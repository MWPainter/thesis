...
\begin{mclistof}{List of Notation}{3.2cm}
    ...
    \item[$\bar{A}$] 
        The bar notation is used to denote sample averages, i.e. $\bar{A}$ is a sample average of a number of samples $A_1,...,A_k$. I.e. $\bar{A}=\frac{1}{n}\sum_{i=1}^k A_i$.
    \item[$\tilde{A}$] 
    ...
    \item[$O(f(x))$]
        \todo{Big-O and Big-Omega notation?} 
    % \\
    % %%%%%
    ...
    \item[TODO]
        \todo{Clean up notation used for maximum entropy tree search}
    \item[$\alpha_{\ments}$] 
