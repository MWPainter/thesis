...
% setup python like code listings for pseudocode
...
\usepackage{thmtools, thm-restate} % restate theorems with same numbering
...
% New theorem envs, compatible with restatable
...
\declaretheorem[name=Counterexample, numberwithin=section]{counterexample}
...
\newcommand{\proofsep}{\medskip\begin{center}\rule{0.4\linewidth}{0.4pt}\end{center}\medskip}
...
% When planning in a simulator with limited time, how can Monte Carlo Tree Search algorithms prioritise exploration to make effective decisions?
\newcommand{\entropyq}{\hyperlink{q11}{\textbf{Q1.1 - Entropy}}}
% Entropy is used as an exploration objective in reinforcement learning --- under what conditions is it compatible with optimal decision-making?
\newcommand{\contextq}{\hyperlink{q12}{\textbf{Q1.2 - Multi-Objective Exploration}}}
% Can the exploration insights from (maximum-entropy) single-objective Monte Carlo Tree Search algorithms be applied to multi-objective domains?
\newcommand{\stochq}{\hyperlink{q2}{\textbf{Q2 - Stochastic Multi-Objective Domains}}}
% Multi-objective Monte Carlo Tree Search has been studied in deterministic domains --- can these methods be generalised to stochastic settings?
\newcommand{\scaleq}{\hyperlink{q3}{\textbf{Q3 - Scalability}}}
% How can the scalability of Monte Carlo Tree Search methods be improved, in both single- and multi-objective settings?
\newcommand{\complexityq}{\hyperlink{q31}{\textbf{Q3.1 - Complexity}}}
% Monte Carlo Tree Search algorithms typically run linearly in the number of trials, actions and decision horizon --- can this computational complexity be reduced?
\newcommand{\moscalabilityq}{\hyperlink{q32}{\textbf{Q3.2 - Multi-Objective Scalability}}}
% With respect to the size of environments, how scalable are multi-objective Monte Carlo Tree Search methods?
% \newcommand{\dimq}{\hyperlink{q33}{\textbf{Q2.3 - Curse of Dimensionality}}}
% % With respect to the number of objectives, to what extent do multi-objective Monte Carlo Tree Search methods suffer from the curse of dimensionality?
...
\newcommand{\ctxsreg}{{\textnormal{\texttt{ctx\_sim\_regr}}}}
...
\newcommand{\reachable}{{\textnormal{Reachable}}}
...
\newcommand{\cnodedata}[1]{{\node(#1)\textnormal{\texttt{.data}}}}
\newcommand{\dnodedata}[1]{{\node(#1)\textnormal{\texttt{.data}}}}
\newcommand{\dotchildren}{{\textnormal{\texttt{.chldrn}}}}
\newcommand{\initq}{{\textnormal{\texttt{init\_q}}}}
\newcommand{\initv}{{\textnormal{\texttt{init\_v}}}}
\newcommand{\mctsmode}{{\textnormal{\texttt{single\_node\_expansion}}}}
\newcommand{\mctsone}{{\textnormal{MCTS-1}}}
\newcommand{\piinit}{{\pi_{\textnormal{heuristic}}}}
\newcommand{\pisearch}{{\pi_{\textnormal{search}}}}
\newcommand{\Qinit}{{\hat{Q}_{\textnormal{heuristic}}}}
\newcommand{\samplecontext}{{\textnormal{\texttt{sample\_context}}}}
\newcommand{\sampleoutcome}{{\textnormal{\texttt{sample\_outcome}}}}
\newcommand{\selectaction}{{\textnormal{\texttt{select\_action}}}}
\newcommand{\thtspp}{{\textnormal{\texttt{THTS++}}}}
\newcommand{\graphmode}{{\textnormal{\texttt{transposition\_table}}}}
\newcommand{\Vinit}{{\hat{V}_{\textnormal{heuristic}}}}
\newcommand{\Vinitbff}{{\hat{\bff{V}}_{\textnormal{heuristic}}}}
\newcommand{\Vh}{{\hat{V}_{\textnormal{h}}}}


\newcommand{\normalisedq}{{\textnormal{\texttt{normalised\_Q}}}}
\newcommand{\norm}{{\textnormal{norm}}}
...
\newcommand{\psiuct}{{\psi_{\uct}}}
\newcommand{\mvuct}{{\texttt{mv}_{\uct}}}
\newcommand{\Quct}{{\bar{Q}_{\uct}}}
\newcommand{\Quctnorm}{{\bar{Q}^{\norm}_{\uct}}}
\newcommand{\Quctbias}{{\bar{Q}^{\bias}_{\uct}}}
\newcommand{\Vuct}{{\bar{V}_{\uct}}}
\newcommand{\Nheuristic}{{N_{\textnormal{heuristic}}}}
\newcommand{\Nvuct}{N^{\Vinit}_{\uct}}
\newcommand{\Nquct}{N^{\Qinit}_{\uct}}

\newcommand{\puct}{{\textnormal{PUCT}}}
\newcommand{\bpuct}{{b_{\puct}}}
\newcommand{\pipuct}{{\pi_{\puct}}}
\newcommand{\Qpuct}{{\bar{Q}_{\puct}}}
\newcommand{\Qpuctnorm}{{\bar{Q}^{\norm}_{\puct}}}
\newcommand{\Vpuct}{{\bar{V}_{\puct}}}
...
% gOOD TURING 
\newcommand{\missingmass}{{\textnormal{\texttt{missing\_mass}}}}
\newcommand{\goodturingestimate}{{\textnormal{\texttt{missing\_mass}}_{\textnormal{GT}}}}
...
\newcommand{\Qbtsbias}{{\hat{Q}^{\bias}_{\bts}}}
\newcommand{\Qbtsnorm}{{\hat{Q}^{\norm}_{\bts}}}
...
\newcommand{\Nvbts}{N^{\Vinit}_{\bts}}
\newcommand{\Nqbts}{N^{\Qinit}_{\bts}}
% Sec 4.2.1 - AR-BTS
...
\newcommand{\Qarbts}{{\bar{Q}_{\arbts}}}
\newcommand{\Qarbtsbias}{{\bar{Q}^{\bias}_{\arbts}}}
\newcommand{\Qarbtsnorm}{{\bar{Q}^{\norm}_{\arbts}}}
\newcommand{\Varbts}{{\bar{V}_{\arbts}}}
...
\newcommand{\Nvarbts}{N^{\Vinit}_{\arbts}}
\newcommand{\Nqarbts}{N^{\Qinit}_{\arbts}}
% Sec 4.2.2 - DENTS
...
\newcommand{\Qdentssoft}{{\hat{Q}^{\sft}_{\dents}}}
\newcommand{\Qdentsbias}{{\hat{Q}^{\sft,\bias}_{\dents}}}
\newcommand{\Qdentsnorm}{{\hat{Q}^{\sft,\norm}_{\dents}}}
\newcommand{\mQdents}[1]{{\hat{Q}^{(#1)}_{\dents}}}
\newcommand{\mQdentssft}[1]{{\hat{Q}^{(#1)}_{\dents,\sft}}}
...
\newcommand{\Nvdents}{N^{\Vinit}_{\dents}}
\newcommand{\Nqdents}{N^{\Qinit}_{\dents}}
% Sec 4.2.2 - AR-DENTS
...
\newcommand{\mHQardents}[1]{{\bar{\cl{H}}^{(#1)}_{Q,\ardents}}}
\newcommand{\HVardents}{{\bar{\cl{H}}_{V,\ardents}}}
\newcommand{\piardents}{{\pi_{\ardents}}}
\newcommand{\mpiardents}[1]{{\pi^{#1}_{\ardents}}}
...
\newcommand{\Qardentssoft}{{\hat{Q}^{\sft}_{\ardents}}}
\newcommand{\Qardentsbias}{{\hat{Q}^{\sft,\bias}_{\ardents}}}
\newcommand{\Qardentsnorm}{{\hat{Q}^{\sft,\norm}_{\ardents}}}
\newcommand{\mQardents}[1]{{\hat{Q}^{(#1)}_{\ardents}}}
\newcommand{\Vardents}{{\bar{V}_{\ardents}}}
\newcommand{\mVardents}[1]{{\hat{V}^{(#1)}_{\ardents}}}
\newcommand{\psiardents}{{\psi_{\ardents}}}
\newcommand{\mpsiardents}[1]{{\psi^{#1}_{\ardents}}}
...
\newcommand{\mmvardents}[1]{{\textup{\texttt{mv}}^{#1}_{\ardents}}}
\newcommand{\Nvardents}{N^{\Vinit}_{\ardents}}
\newcommand{\Nqardents}{N^{\Qinit}_{\ardents}}
...
% Sec 5.2 - CZT
\newcommand{\czt}{\textnormal{\texttt{CZT}}}
\newcommand{\bczt}{b_{\czt}}
\newcommand{\dczt}{d_{\textnormal{czt}}}
\newcommand{\Cczt}{C_{\textnormal{czt}}}
\newcommand{\ball}{\textnormal{\texttt{ball}}}
\newcommand{\Vczt}{\bar{V}_{\czt}}
\newcommand{\Qczt}{\bar{\bff{Q}}_{\czt}}
\newcommand{\pre}{\textnormal{\texttt{pre}}}
\newcommand{\Ipreczt}{I^{\pre}_{\czt}}
\newcommand{\Iczt}{I_{\czt}}
\newcommand{\selectball}{\textnormal{\texttt{select\_ball}}}
\newcommand{\piczt}{\pi_{\czt}}
\newcommand{\psiczt}{\psi_{\czt}}
...
% CHBTS
\newcommand{\chbts}{{\textnormal{CH-BTS}}}
\newcommand{\alphachbts}{{\alpha_{\chbts}}}
\newcommand{\epschbts}{{\epsilon_{\chbts}}}
\newcommand{\lambdachbts}{{\lambda(s,\epschbts)}}
\newcommand{\rhochbts}{{\rho_{\chbts}}}
\newcommand{\pichbts}{{\pi_{\chbts}}}
\newcommand{\Vchbts}{{\hat{\bfcl{V}}_{\chbts}}}
\newcommand{\Qchbts}{{\hat{\bfcl{Q}}_{\chbts}}}
\newcommand{\Vchbtsctx}[1]{{\hat{V}^{#1}_{\chbts}}}
\newcommand{\Qchbtsctx}[1]{{\hat{Q}^{#1}_{\chbts}}}
...
\newcommand{\ucheby}{{u_{\textnormal{chebychev}}}}
\newcommand{\ruto}{\bff{r}_{\textnormal{uto}}}
\newcommand{\rutocomp}{\left(r_{\textnormal{uto}}\right)}
\newcommand{\cchmcts}{{\textnormal{C-CHMCTS}}}
\newcommand{\zetcchmcts}{{\zeta_{\cchmcts}}}

% Pateto CHMCTS
\newcommand{\pareto}{{\textnormal{P-CHMCTS}}}
\newcommand{\bpareto}{{b_{\pareto}}}
\newcommand{\Vpareto}{{\hat{\bfcl{V}}_{\pareto}}}
\newcommand{\Qpareto}{{\hat{\bfcl{Q}}_{\pareto}}}
\newcommand{\Vparetoconf}{{\hat{\bfcl{V}}^{\conf}_{\pareto}}}
\newcommand{\Vparetou}{{\hat{\bfcl{V}}^{U}_{\pareto}}}
\newcommand{\pipareto}{{\pi_{\pareto}}}
...
\newcommand{\pswept}{{p_\textnormal{\texttt{swept}}}}
\newcommand{\DST}{{\textnormal{\texttt{DST}}}}
...
\newcommand{\simplex}{{\textnormal{\texttt{simplex}}}}
\newcommand{\fcs}{{\textnormal{\texttt{find\_containing\_simplex}}}}
\newcommand{\fcv}{{\textnormal{\texttt{find\_closest\_vertex}}}}
\newcommand{\update}{{\textnormal{\texttt{update}}}}
\newcommand{\push}{{\textnormal{\texttt{push}}}}
\newcommand{\splitsimplex}{{\textnormal{\texttt{maybe\_split}}}}
\newcommand{\splitsimplexcounter}{{\textnormal{\texttt{N}}_{\SM}}}
\newcommand{\splitmindelta}{{\textnormal{\texttt{split\_min\_delta}}_{\SM}}}
\newcommand{\splitminradius}{{\textnormal{\texttt{split\_min\_radius}}_{\SM}}}
\newcommand{\splitminvis}{{\textnormal{\texttt{split\_min\_visit}}_{\SM}}}
\newcommand{\pushradius}{{\textnormal{\texttt{push\_radius}}_{\SM}}}
\newcommand{\GSM}{{\bfcl{G}_{\SM}}}
\newcommand{\VSM}{{\bfcl{V}_{\SM}}}
\newcommand{\ESM}{{\bfcl{E}_{\SM}}}
\newcommand{\TSM}{{\bfcl{T}_{\SM}}}
\newcommand{\SSM}{{\bfcl{S}_{\SM}}}
\newcommand{\fSM}{{f_{\SM}}}
\newcommand{\wSM}{{\bff{w}_{\SM}}}
\newcommand{\wSMi}[1]{{\bff{w}^{(#1)}_{\SM}}}
\newcommand{\wSMprime}{{\bff{w}'_{\SM}}}
\newcommand{\Qsmctx}[1]{{\hat{Q}^{#1}_{\SM}}}





\newcommand{\SMDENTS}{{\textnormal{SM-DNTS}}}
\newcommand{\pushradiusdents}{{\textnormal{\texttt{push\_radius}}_{\SMDENTS}}}
\newcommand{\Vsmdctx}{{\hat{V}^{\bff{w}}_{\SMDENTS}}}
\newcommand{\Qsmdctx}{{\hat{Q}^{\bff{w}}_{\SMDENTS}}}
\newcommand{\Qsmdctxcstm}[1]{{\hat{Q}^{(#1)}_{\SMDENTS}}}
\newcommand{\Vsmd}{{\hat{\bff{V}}_{\SMDENTS}}}
\newcommand{\Qsmd}{{\hat{\bff{Q}}_{\SMDENTS}}}
\newcommand{\wV}{{\bff{w}_V}}
\newcommand{\wQ}{{\bff{w}_Q}}
\newcommand{\fSMV}{{f^V_{\SM}}}
\newcommand{\fSMQ}{{f^Q_{\SM}}}
\newcommand{\HSM}{{\cl{H}}_{\SM}}
\newcommand{\HVsmd}{{\bar{\cl{H}}_{V,\SMDENTS}}}
\newcommand{\HQsmd}{{\bar{\cl{H}}_{Q,\SMDENTS}}}
\newcommand{\Qsmdsoft}{{\hat{Q}^{\bff{w},\sft}_{\SMDENTS}}}
\newcommand{\alphasmd}{{\alpha_{\SMDENTS}}}
\newcommand{\betasmd}{{\beta_{\SMDENTS}}}
\newcommand{\epssmd}{{\epsilon_{\SMDENTS}}}
\newcommand{\lambdasmd}{{\lambda(s,\epssmd)}}
\newcommand{\rhosmd}{{\rho_{\SMDENTS}}}
\newcommand{\pismd}{{\pi_{\SMDENTS}}}
\newcommand{\psismd}{{\psi_{\SMDENTS}}}



% Appendix
\newcommand{\uctbudget}{{\texttt{uct\_budget}}}
\newcommand{\Nv}{N^{\Vinit}}
\newcommand{\Nq}{N^{\Qinit}}
\newcommand{\Qnorm}{{\bar{Q}^{\norm}}}
\newcommand{\Qbias}{{\bar{Q}^{\bias}}}
\newcommand{\alphadecay}{{\alpha_{\text{decay}}}}
\newcommand{\betathresh}{{\beta_{\text{thresh}}}}
...
\include{text/appendix-ch4-alg-ref}
\include{text/appendix-ch4-expr-deets}
\include{text/appendix-ch5-expr-deets}
