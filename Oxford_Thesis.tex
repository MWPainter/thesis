...
\newcommand{\entropyq}{\hyperlink{q2}{\textbf{Q2 - Entropy}}}
\newcommand{\complexityq}{\hyperlink{q3}{\textbf{Q3 - Complexity}}}
\newcommand{\scalabilityq}{\hyperlink{q4}{\textbf{Q4 - Scalability}}}
\newcommand{\dimq}{\hyperlink{q5}{\textbf{Q5 - Dimensionality}}}
\newcommand{\evalq}{\hyperlink{q6}{\textbf{Q6 - Tree Evaluation}}}
\newcommand{\morlevalq}{\hyperlink{q7}{\textbf{Q7 - Multi-Objective Evaluation}}}

% Sec 2.2 - THTS++ macros
\newcommand{\CNODE}{{\texttt{CNODE}}}
\newcommand{\cnode}{{\texttt{cnode}}}
\newcommand{\DNODE}{{\texttt{DNODE}}}
\newcommand{\dnode}{{\texttt{dnode}}}
\newcommand{\mctsmode}{{\texttt{mcts\_mode}}}
\newcommand{\runtrial}{{\texttt{run\_trial}}}
\newcommand{\thtspp}{{\texttt{THTS++}}}
...
\clearpage
  \todo{list}
  \begin{enumerate}
    \item Copy contributions from conformation and write out properly
    ...
    \item Have all outline finsihed
  \end{enumerate}
}
...
\include{text/appendix-p1-chmcts-paper}
\include{text/appendix-p2-dents-paper}
\include{text/appendix-p3-simplexmaps-paper}
