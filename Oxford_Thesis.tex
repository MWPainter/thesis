...
% Sec 2.2 - MDPs + RL macros
\newcommand{\sft}{{\textnormal{sft}}}
\newcommand{\suc}[2]{{\textnormal{Succ}(#1,#2)}}

% Sec 2.3 - THTS++ macros
\newcommand{\children}{{\textnormal{\texttt{children}}}}
\newcommand{\CNODE}{{\textnormal{\texttt{CNODE}}}}
\newcommand{\cnode}{{\textnormal{\texttt{cnode}}}}
\newcommand{\DNODE}{{\textnormal{\texttt{DNODE}}}}
\newcommand{\dnode}{{\textnormal{\texttt{dnode}}}}
\newcommand{\mctsmode}{{\textnormal{\texttt{mcts\_mode}}}}
\newcommand{\node}{{\textnormal{\texttt{node}}}}
\newcommand{\runtrial}{{\textnormal{\texttt{run\_trial}}}}
\newcommand{\thtspp}{{\textnormal{\texttt{THTS++}}}}
\newcommand{\Vinit}{{V_{\textnormal{init}}}}

% Sec 2.3.X - UCT/MCTS/MENTS macros
