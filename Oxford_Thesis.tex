...
\newcommand{\lambdachbts}{{\lambda_{\chbts}(s,\epschbts)}}
...
\newcommand{\splitsimplex}{{\textnormal{\texttt{split}}}}
...
\newcommand{\SMDENTS}{{\textnormal{SM-DENTS}}}
\newcommand{\pushradiusdents}{{\textnormal{\texttt{push\_radius}}_{\SMDENTS}}}
\newcommand{\Vsmdctx}[1]{{\hat{Q}^{#1}_{\SMDENTS}}}
\newcommand{\Qsmdctx}[1]{{\hat{Q}^{#1}_{\SMDENTS}}}
