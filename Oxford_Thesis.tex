...
\newcommand{\kHQdents}[1]{{\bar{\cl{H}}^{(#1)}_{Q,\dents}}}
\newcommand{\HVdents}{{\bar{\cl{H}}_{V,\dents}}}
\newcommand{\kHVdents}[1]{{\bar{\cl{H}}^{(#1)}_{V,\dents}}}
\newcommand{\pidents}{{\pi_{\dents}}}
\newcommand{\kpidents}[1]{{\pi^{#1}_{\dents}}}
\newcommand{\rhodents}{{\rho_{\dents}}}
\newcommand{\krhodents}[1]{{\rho^{#1}_{\dents}}}
\newcommand{\alphadents}{{\alpha_{\dents}}}
\newcommand{\betadents}{{\beta_{\dents}}}
\newcommand{\Qdents}{{\hat{Q}_{\dents}}}
\newcommand{\kQdents}[1]{{\hat{Q}^{(#1)}_{\dents}}}
\newcommand{\Vdents}{{\hat{V}_{\dents}}}
\newcommand{\kVdents}[1]{{\hat{V}^{(#1)}_{\dents}}}
\newcommand{\kVrhodents}[1]{{\hat{V}^{(#1)}_{\rho,\dents}}}
\newcommand{\psidents}{{\psi_{\dents}}}
\newcommand{\kpsidents}[1]{{\psi^{#1}_{\dents}}}
\newcommand{\epsdents}{{\epsilon_{\dents}}}
\newcommand{\lambdadents}{{\lambda(s,\epsdents)}}
\newcommand{\klambdadents}[1]{{\lambda^{#1}(s,\epsdents)}}
\newcommand{\mvdents}{{\texttt{mv}_{\dents}}}
\newcommand{\kmvdents}[1]{{\texttt{mv}^{#1}_{\dents}}}
% Sec 4.2.2 - AR-DENTS
\newcommand{\ardents}{{\textnormal{DENTS}}}
...
\include{text/appendix-go-results}
